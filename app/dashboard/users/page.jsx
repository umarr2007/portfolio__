    ...
    return (
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            >
                ...
                <p className="text-sm text-gray-500">{user.address.geo.lat}</p>
                <p className="text-sm text-gray-500">{user.address.geo.lng}</p>
                ...
                <p className="text-gray-700 mt-4">{user.body}</p>
            </div>
            ))}
        </div>
